	...
	require 'gosu'
	require_relative 'cls/tile'
	require_relative 'cls/breakable_tile'
	require_relative 'cls/conditional_tile'
	require_relative 'cls/decortile'
	require_relative 'cls/faketiles'
	require_relative 'cls/hazard_tile'
	require_relative 'cls/player'
	require_relative 'cls/enemy'
	require_relative 'cls/button'
	require_relative 'cls/particle'
	require_relative 'cls/portrait'
	require_relative 'cls/hpd'
	require_relative 'cls/crosshair'
	require_relative 'cls/stone'
	require_relative 'cls/visual_gem'
