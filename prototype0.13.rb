...
class GameWindow < Gosu::Window
	...
	def placeconditionalplatformtile(x, y, id, rid, lid, tid, bid, nid, animlength, condition, write, reverse, tiles = $tilesimage)
		@conditionalplatformtilemap.push(Con ditionalTile.new(x, y, id, rid, lid, tid, bid, nid, animlength, condition, write, reverse, tiles))
	end
