class Player
	...
	def draw
		...
		if @aimcharge > 0 and @aimcharge < 30
			@stonebar[@sb].draw(@x - $xcamera, @y + 12 - $ycamera, 35 + @p, @sbwidth, 1)
		elsif @aimcharge >= 30
			@stonebar[@sb].draw(@x - $xcamera, @y + 12 - $ycamera, 35 + @p, 10, 1)
		end
		if facing == "right"
			if @hurt == 0 or @hurt == 1
				if @aimdir == "none"
			...
			@tpsprites[@sprite].draw(@x - $xcamera - 3, @y - $ycamera - 3, 20 + @p, 1, 1, @skin_color)
			@clsprites[@sprite].draw(@x - $xcamera - 3, @y - $ycamera - 3, 20 + @p, 1, 1, @cloak_color)
			@tcsprites[@sprite].draw(@x - $xcamera - 3, @y - $ycamera - 3, 20 + @p, 1, 1, @cloak_color2)
			@stsprites[@sprite].draw(@x - $xcamera - 3, @y - $ycamera - 3, 20 + @p, 1, 1, @string_color)
			
			if @aimcharge > 0 and @aimcharge < 10
				@slingshot[0].draw_rot(@x - $xcamera + (@width / 2), @y - $ycamera + (@height / 2), 20 + @p, @aimdeg - 90, 0.5, 0.5, 1, 1, 0xff_ffffff)
			elsif @aimcharge >= 10 and @aimcharge < 20
				@slingshot[1].draw_rot(@x - $xcamera + (@width / 2), @y - $ycamera + (@height / 2), 20 + @p, @aimdeg - 90, 0.5, 0.5, 1, 1, 0xff_ffffff)
			elsif @aimcharge >= 20 and @aimcharge < 30
				@slingshot[2].draw_rot(@x - $xcamera + (@width / 2), @y - $ycamera + (@height / 2), 20 + @p, @aimdeg - 90, 0.5, 0.5, 1, 1, 0xff_ffffff)
			elsif @aimcharge >= 30
				@slingshot[3].draw_rot(@x - $xcamera + (@width / 2), @y - $ycamera + (@height / 2), 20 + @p, @aimdeg - 90, 0.5, 0.5, 1, 1, 0xff_ffffff)
			end
			...
			@tpsprites[@sprite].draw(@x - $xcamera + 16 - 3, @y - $ycamera - 3, 20 + @p, -1.0, 1.0, @skin_color)
			@clsprites[@sprite].draw(@x - $xcamera + 16 - 3, @y - $ycamera - 3, 20 + @p, -1, 1, @cloak_color)
			@tcsprites[@sprite].draw(@x - $xcamera + 16 - 3, @y - $ycamera - 3, 20 + @p, -1, 1, @cloak_color2)
			@stsprites[@sprite].draw(@x - $xcamera + 16 - 3, @y - $ycamera - 3, 20 + @p, -1, 1, @string_color)
